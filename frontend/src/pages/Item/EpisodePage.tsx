        ...
        <BaseMediaPage itemId={item.SeriesId || ''} name={item.SeriesName || item.Name || ''} showLogo={false} topPadding={false}>
            <div className="pt-24 sm:pt-32 pb-12 px-4 sm:px-12 max-w-7xl mx-auto w-full flex flex-col gap-12">
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start relative z-10 w-full">
                    {/* Left Column (Episode Thumbnail) */}
                    <div className="w-full sm:w-1/3 lg:w-1/4 shrink-0 mx-auto lg:mx-0">
                        <div className="relative aspect-video w-full rounded-xl overflow-hidden shadow-2xl shadow-black/85 border border-white/10 bg-muted flex items-center justify-center">
                            {!imageError ? (
                                <>
                                    ...
                                    <img
                                        ...
                                        className={[
                                            'w-full h-full object-cover rounded-xl relative z-10',
                            ...
                            {progress > 0 && (
                                <div className="absolute bottom-0 left-0 right-0 h-1.5 bg-black/60 rounded-b-xl overflow-hidden z-15">
                                    <div
